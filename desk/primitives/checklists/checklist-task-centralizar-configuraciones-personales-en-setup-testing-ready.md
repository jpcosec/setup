---
# checklist-xxx
id: checklist-task-centralizar-configuraciones-personales-en-setup-testing-ready
# draft | active | complete | archived
status: active
# List of condition-xxx paths
condition_refs:
- condition-task-centralizar-configuraciones-personales-en-setup-has-validation
# all | any
mode: all
# e.g., system:deskops
tags:
